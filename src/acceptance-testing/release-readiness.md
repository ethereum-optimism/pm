...
flowchart TD
    subgraph Prerequisites
        A[All new features have acceptance testing coverage]
        B[Acceptance tests from Release Readiness Checklist passing]
    end
    
    subgraph Phases
        C[1. Deployment]
        D[2. Acceptance Testing]
        E[3. Results Analysis]
        F[4. Release Determination]
        G[5. Release]
    end
    ...
    subgraph Criteria
        F1[Zero critical issues]
        F2[Mitigation plans for major issues]
        F3[Document minor issues]
    end
